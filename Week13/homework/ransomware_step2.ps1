...
foreach ($file in $filelist) {
    ...
    # Write-Host to show files would be encrypted. I don't want to accidently run this on my host.
    Write-Host "Invoke-AESEncryption -Mode Encrypt -Key 'p@ssw0rd' -Path $($file.FullName)"
}
